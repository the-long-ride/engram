---
name: engram
description: "Your knowledge memory manager, synced across every device with Git."
---
...
- Prefer MCP for `load`, `search`, `verify`, `status`, `save`, and `engram_save_session` proposals.
