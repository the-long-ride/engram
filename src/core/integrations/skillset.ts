...
/engram {{args}}
Prefer MCP for load/search/verify/status/save/autosave proposals. If args contain "autosave --accept-all", generate candidates when needed and pass them to the CLI with --accept-all. Otherwise run: engram {{args}}
