...
export const HELP_DATA: HelpSection[] = [
  ...
  },
  {
    ...
    commands: [
      ...
      { command: 'engram install-agent-hooks [target|all] [--global] [--plan] [--force]', alias: 'iah', purpose: 'Install opt-in AI agent hooks for Codex, Claude, and Gemini context injection' },
      { command: 'engram uninstall-agent-hooks [target|all] [--global]', alias: 'uah', purpose: 'Remove only Engram-managed AI agent hook entries' },
