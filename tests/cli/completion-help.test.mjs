...
assert.match(bash.stdout, /--workspace --global --all --force --dry-run/);
  ...
  assert.match(bash.stdout, /--migrate-memories/);
  assert.match(bash.stdout, /--no-migrate-memories/);
...
assert.match(zsh.stdout, /-f\[load broader legacy memory output\]/);
  ...
  assert.match(zsh.stdout, /--migrate-memories/);
  assert.match(zsh.stdout, /--no-migrate-memories/);
  ...
  assert.match(powershell.stdout, /'--migrate-memories'/);
  assert.match(powershell.stdout, /'--no-migrate-memories'/);
