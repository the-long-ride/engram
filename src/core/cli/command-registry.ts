...
export const HELP_DATA: HelpSection[] = [
  ...
  },
  {
    ...
    commands: [
      ...
      { command: 'engram save-session [--file transcript.md] [--scope workspace|global|both] [--role role] [--query-level n] [--force] [--show-rule-variants] [session-summary]', alias: 'ss', purpose: 'Propose multiple memories; force writes ready candidates and defers related-memory decisions with ID-only inspect guidance' },
