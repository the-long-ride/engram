...
export const HELP_DATA: HelpSection[] = [
  ...
  },
  {
    ...
    commands: [
      ...
      { command: 'engram save-session [--file transcript.md] [--scope workspace|global|both] [--role role] [--query-level n] [--force] [--show-rule-variants] [session-summary]', alias: 'ss', purpose: 'Propose multiple memories from one or more recent sessions before approval or explicit force write' },
