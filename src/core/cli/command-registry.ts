...
export const HELP_DATA: HelpSection[] = [
  ...
  },
  {
    ...
    commands: [
      ...
      { command: 'engram save-session [--file transcript.md] [--role role] [--query-level n] [--accept-all] [session-summary]', alias: 'ss', purpose: 'Propose multiple memories from one or more recent sessions before approval or explicit accept-all' },
