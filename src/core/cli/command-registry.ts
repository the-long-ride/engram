...
export const HELP_DATA: HelpSection[] = [
  ...
  },
  {
    ...
    commands: [
      { command: 'engram save rule [--scope workspace|global|both] [--role role] [--task-type task_type] <text>', alias: 's', purpose: 'Draft and save a rule memory after user approval with task-type routing tag' },
      { command: 'engram save skill [--scope workspace|global|both] [--role role] [--task-type task_type] <text>', alias: 's', purpose: 'Draft and save a skill memory after user approval with task-type routing tag' },
      { command: 'engram save workflow [--scope workspace|global|both] [--role role] [--task-type task_type] <text>', alias: 's', purpose: 'Draft and save a repeatable workflow as a skill memory with task-type routing tag' },
      { command: 'engram save knowledge [--scope workspace|global|both] [--role role] [--task-type task_type] [text]', alias: 's', purpose: 'Draft and save a knowledge memory (agent summary or text) with task-type routing tag' },
      { command: 'engram save [--scope workspace|global|both] [--role role] [--task-type task_type] [text]', alias: 's', purpose: 'Auto-detect rule, workflow, skill, or knowledge memory from text and add task-type routing tag' },
  ...
  },
  {
    ...
    commands: [
      ...
      { command: 'engram set-read auto|manual|off|always|status', alias: 'rd', purpose: 'Configure how and when engram load is used (always loads on every new request/turn)' },
